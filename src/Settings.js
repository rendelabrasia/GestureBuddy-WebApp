...
import diagram from './AlphabetsAndNumbers.png';
import diagram1 from './Gestures.png';
...
return (
    ...
    />
         ...
         <h2> Help And Tutorial </h2>
           <p>The image presents a comprehensive visual guide to the American Sign Language (ASL) alphabet, showcasing illustrations of hands demonstrating the handshapes used to represent each letter from A through Z, and numbers 1 through 9. Additionally, it includes 15 common ASL gestures used in everyday communication. Each handshape and gesture corresponds to elements of the English alphabet and numeric system, serving as a vital tool for non-verbal communication. This guide is especially beneficial for the deaf and hard of hearing community. Incorporating this guide on a website dedicated to inclusivity not only enriches the user experience but also promotes accessibility, allowing visitors to learn and utilize basic sign language, thereby making the website's content more accessible to those who rely on ASL.</p>           <img src={diagram} alt="American Sign Language Alphabet" style={{ display: 'block', marginLeft: 'auto', marginRight: 'auto', width: '600px', height: 'auto' }} />
           <img src={diagram1} alt="Gestures" style={{ maxWidth: '100%', height: 'auto' }} />
         </div>  
          )}
